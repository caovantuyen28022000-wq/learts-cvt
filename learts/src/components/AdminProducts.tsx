...
const AdminProducts: React.FC = () => {
  ...
  useEffect(() => {
    fetchProducts({ page: 1, limit: 100 }); // fetch all products for dashboard view
    fetchCategories();
  }, []);
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.name || isNaN(priceNum) || !formData.image || isNaN(stockNum) || isNaN(catIdNum)) {
      setFormMsg("Please enter valid product details. Price, Stock and Category are required.");
      return;
    }
    ...
    if (success) {
      ...
      setFormMsg("Action failed. Check logs and try again.");
    }
  };
      ...
      <div className="section section-padding bg-light">
        <div className="container">
          <div className="d-flex justify-content-between align-items-center mb-4">
            <h2 className="m-0" style={{ fontFamily: 'Playfair Display, serif', fontWeight: 400 }}>Product Inventory</h2>
                ...
                <div className="row g-3">
                  ...
                  <div className="col-md-6 text-start">
                    ...
                    <input 
                      ...
                      onChange={handleInputChange}
                      required 
                      placeholder="e.g. assets/images/product/s328/product-1.webp"
                    />
                  </div>
          ...
          <div className="card shadow-sm border-0 p-4 bg-white" style={{ borderRadius: '8px' }}>
            {loading ? (
              ...
              <div className="text-center py-5 text-muted">
                ...
                <p>No products in database catalog. Click "+ Add New Product" to seed your store.</p>
              </div>
            ) : (
